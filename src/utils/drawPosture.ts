...
import { POSTURE_CONFIGS, POSTURE_LABELS, PersonPosture, type PostureIconConfig } from './postureIcons';
...
function drawSVGIcon(
	...
	if (config.type === "svg" && config.iconPath) {  // 类型守卫
...
function drawLabel(
 ...
 ctx.fillStyle = isWarning ? "#ff4d4f" : "#1a202c";
